...
fo = sys.argv[2]
#fi = '../dat/utah_by_zcta_1998.txt'
#fo = '../dat/utah_by_zcta_1998.xml'
print fi
...
for line in open(fi):
    ...
    [zcta, year, panp, ph, pop, change_panp, change_ph, change_pop] = line.strip().split('\t')

    user.appendChild(atomNode(doc, 'zcta', zcta))
